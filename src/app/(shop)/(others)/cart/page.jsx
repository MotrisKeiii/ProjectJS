        ...
        <div className="grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
          ...
          <aside className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm lg:sticky lg:top-6">
            ...
            <Link
              href="/checkout"
              type="button"
              className=" mt-6 w-full rounded-xl bg-slate-900 px-5 py-3 text-sm font-semibold text-white shadow-sm transition duration-200 hover:bg-slate-800 active:scale-[0.98] "
            >
